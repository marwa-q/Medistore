...
<body class="bg-light">
    <div class="container s" style="margin-top: 72px;">
                ...
                <div class="card p-4 shadow-sm">
                    ...
                    <form id="profileForm">
                        <div class="mb-3">
                            ...
                            <input type="text" name="full_name" id="fullName" class="form-control" placeholder="<?= htmlspecialchars($user['full_name'] ?? ''); ?>">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Phone Number</label>
                            <input type="text" name="phone" id="phone" class="form-control" placeholder="<?= htmlspecialchars($user['phone_number'] ?? ''); ?>">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Street Address</label>
                            <input type="text" name="address" id="address" class="form-control" placeholder="<?= htmlspecialchars($user['address'] ?? ''); ?>">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Email</label>
                            <input type="email" name="email" id="email" class="form-control" placeholder="<?= htmlspecialchars($user['email'] ?? ''); ?>">
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Function to save changes using Fetch API
